...
const TASKS = {
  ...
  gnat_nuke:      { room:"garden", label:"🦟 GNAT WAR v2: peroxide drench every indoor pot (1 part 3% peroxide : 4 parts water, watered through) + lay yellow sticky traps FLAT on the soil", level:"easy" },
  gnat_sand:      { room:"garden", label:"🦟 Cap every indoor pot with about half an inch of sand or fine aquarium gravel (blocks egg-laying) + BTI-tea watering, week 2", level:"easy" },
  gnat_check2:    { room:"garden", label:"🦟 Trap check, week 3 — numbers dropping? Keep BTI tea going; any pot still hatching gnats gets flagged for a repot with fresh bagged mix", level:"easy" },
...
const PLANTS = [
  ...
  { id:"mint", light:"⛅ Part shade ok", waterChip:"💧 every 3 days — evenly moist", harvestChip:"✂️ recovering — once back: pick as you cook · pinch tips to bush it out",     name:"Peppermint",      emoji:"🌿", loc:"greenhouse", freq:"🌱 Recovering — new growth Jun 6; keep evenly moist, it's coming back. Gentle morning water", days:3, overwater:true, trimDays:7,
  ...
  // ── OUTDOOR EDIBLES ───────────────────────────────────────────────────────
  { id:"strawberry", light:"☀️ Full sun 6–10h", waterChip:"💧 daily", harvestChip:"🍓 pick only when fully red — light right now",    name:"Strawberry",         emoji:"🍓", loc:"outdoor", freq:"Daily — single round pot in full sun, so it dries out fast. Water deeply at the base each morning; in a heat wave it may want a second drink in the evening. Keep soil consistently moist while flowering and fruiting.", days:1, trimDays:14,
...
const WATER_INFO = {
  philodendron:{when:"Check weekly. Water only when the top 1–2 inches of soil feel dry, then water deeply until it drains from the bottom and empty the saucer. Keep it in bright indirect light. 🦟 GNAT WAR: until the gnats are gone, EVERY watering = BTI tea (Mosquito Bits steeped 24 hrs) — no plain water.",thirst:"Forgiving and drought-tolerant — it would much rather sit a little dry than soggy, which rots its roots."},
  ivy:{when:"Water about weekly, when the top inch is dry — soak until it drains, then tip out the saucer. Mist the leaves or group it with other plants for humidity. 🦟 GNAT WAR: until the gnats are gone, EVERY watering = BTI tea (Mosquito Bits steeped 24 hrs) — no plain water.",thirst:"A thirsty plant that still hates wet feet: it wants the soil moist but never standing in water."},
  fittonia:{when:"Check every 2 days — bark mulch mix dries fast. Water when the top inch is barely dry; don't let it reach the droop. Place on a pebble tray with water underneath for humidity. Keep away from AC vents. 🦟 GNAT WAR: until the gnats are gone, EVERY watering = BTI tea (Mosquito Bits steeped 24 hrs) — no plain water.",thirst:"The drama queen: it collapses flat the instant it's thirsty, then springs back upright within an hour of a drink. But bark mix dries faster than potting soil — don't wait for the faint."},
  croton:{when:"Water when the top inch is dry, usually every 5–7 days, keeping it evenly moist in bright warm light. Do not let it fully dry out. 🦟 GNAT WAR: until the gnats are gone, EVERY watering = BTI tea (Mosquito Bits steeped 24 hrs) — no plain water.",thirst:"Sensitive to swings — both bone-dry soil and cold drafts make it drop leaves in protest."},
  jade:{when:"Let the soil dry out completely, then water deeply and leave it alone for 2–3 weeks. Water much less in winter. 🦟 GNAT WAR: until the gnats are gone, EVERY watering = BTI tea (Mosquito Bits steeped 24 hrs) — no plain water.",thirst:"A true succulent that stores water in its leaves, so underwatering is nearly impossible — but overwatering is fatal."},

...
const PLANTS = [
  ...
  // ── GREENHOUSE HERBS ──────────────────────────────────────────────────────
  { id:"basil1", light:"☀️ Full sun 6–8h", waterChip:"💧 every 3 days", harvestChip:"✂️ pinch every ~10 days — more = bushier",   name:"Sweet Basil #1",  emoji:"🌿", loc:"greenhouse", freq:"Morning only — top 2 inches dry before watering. Greenhouse stays humid at night", days:3, overwater:true, trimDays:10,
  ...
  { id:"basil2", light:"☀️ Full sun 6–8h", waterChip:"💧 every 3 days", harvestChip:"✂️ pinch every ~10 days — more = bushier",   name:"Sweet Basil #2",  emoji:"🌿", loc:"greenhouse", freq:"Morning only — top 2 inches dry before watering", days:3, overwater:true, trimDays:10,
  ...
  // ── OUTDOOR EDIBLES ───────────────────────────────────────────────────────
  { id:"strawberry", light:"☀️ Full sun 6–10h", waterChip:"💧 daily", harvestChip:"🍓 check every ~5 days in season",    name:"Strawberry",         emoji:"🍓", loc:"outdoor", freq:"Daily — single round pot in full sun, so it dries out fast. Water deeply at the base each morning; in a heat wave it may want a second drink in the evening. Keep soil consistently moist while flowering and fruiting.", days:1, trimDays:14,

...
const PLANTS = [
  ...
  // ── GREENHOUSE HERBS ──────────────────────────────────────────────────────
  { id:"basil1", light:"☀️ Full sun 6–8h", waterChip:"💧 every 3 days", harvestChip:"✂️ REQUIRED: pinch every 1–2 weeks — keeps it producing · use or preserve what you pinch",   name:"Sweet Basil #1",  emoji:"🌿", loc:"greenhouse", freq:"Morning only — top 2 inches dry before watering. Greenhouse stays humid at night", days:3, overwater:true, trimDays:12,
  ...
  { id:"basil2", light:"☀️ Full sun 6–8h", waterChip:"💧 every 3 days", harvestChip:"✂️ REQUIRED: pinch every 1–2 weeks — keeps it producing · use or preserve what you pinch",   name:"Sweet Basil #2",  emoji:"🌿", loc:"greenhouse", freq:"Morning only — top 2 inches dry before watering", days:3, overwater:true, trimDays:12,
  ...
  { id:"jalapeno", light:"☀️ Full sun 6–8h", waterChip:"💧 every 2–3 days", harvestChip:"🌶️ fruiting — firm full-size green peppers are ready now · leave longer for red", name:"Jalapeño", emoji:"🌶️", loc:"outdoor", freq:"Morning at the base — every 2-3 days, let the top 2 inches dry. Less water = hotter pepper.", days:2, trimDays:21,
    note:"Jul 14 photo — actively flowering and carrying several glossy green peppers. Upper growth looks healthy; a few older lower leaves have mild yellow margins and limited chewing damage.",
    trim:"Fruit is already set, so do not pinch flowers now. Remove only yellow or badly damaged lower leaves, inspect leaf undersides for pests, and support a branch if the pepper load starts bending it. Harvest firm, full-size green peppers promptly to encourage continued production, or leave selected fruit to ripen red." },
  ...
  { id:"green_onion", light:"☀️ Full sun", waterChip:"💧 every 2 days — check soil first", harvestChip:"✂️ snip green tops as you cook — they regrow", name:"Green Onions", emoji:"🧅", loc:"outdoor", freq:"The green onions now share the wide shallow gray pot only with the recovering white onion. Check the top inch every day during the heat and water the pot when it starts drying, usually about every 2 days.", days:2, trimDays:14,
  ...
  { id:"potato_sprout", light:"☀️ Full sun · afternoon shade while establishing", waterChip:"💧 check daily — small temporary pot", harvestChip:"🥔 early growth — harvest after tops die back", name:"Golden Potato · Small Temp Pot", emoji:"🥔", loc:"outdoor", freq:"The small temporary pot can dry quickly in the mid-90s heat. Check it every morning and water when the top inch starts drying; keep it evenly moist while the new sprout establishes, not constantly wet.", days:1, trimDays:21, note:"Jul 12 — the smaller potato was moved to a temporary pot and has just sprouted above the soil.",
    trim:"Do not trim the new sprout. Once it has several inches of sturdy growth, begin adding soil gradually while keeping the upper leaves exposed. Move it to a deeper final container before it becomes root-bound." },
  { id:"white_onion", light:"☀️ Full sun", waterChip:"💧 only when top inch dries — rot recovery", harvestChip:"🧅 lift when the tops flop over", name:"White Onion · Recovering", emoji:"🧅", loc:"outdoor", freq:"The white onion shares the wide shallow gray pot only with the green onions. Because rot was removed from around its roots, check the soil before watering and let the top inch dry; do not keep the bulb base constantly wet.", days:2, trimDays:30, overwater:true, note:"Jul 12 — root rot was removed and the onion was replanted. It looked better the next day; monitor for renewed softness, smell, or yellowing.",
    trim:"Leave healthy tops intact while it recovers. Keep the bulb neck at or just above soil level and remove any newly soft tissue. The plan is to move both onions later and dedicate the shallow gray pot to strawberries; until that happens, this card remains active here." },
  ...
  { id:"turmeric", light:"🌥️ Part shade — bright, no harsh afternoon sun", waterChip:"💧 check daily · water only as soil dries", harvestChip:"🫚 ~8–10 months — lift when leaves yellow & die back", name:"Turmeric · Temp Pot", emoji:"🫚", loc:"outdoor", freq:"Now in its own temporary pot. Check it daily during the heat, but because it has not rooted or sprouted yet, water only when the top inch starts to dry. Warm and lightly moist is the goal; soggy soil can rot the rhizomes.", days:2, trimDays:30, overwater:true, note:"Jul 12 — moved into its own temporary pot. The rhizomes look healthy but have not rooted or sprouted yet.",
...
const PLANT_INFO = {
  turmeric:     { fact:"Turmeric is ginger's cousin — same rhizome family; its bright orange flesh is what colors curry, and it can take several weeks to break the surface after planting." },
  ...
  basil1:       { fact:"Basil is in the mint family, and pinching it makes it bushier — the more you harvest, the more it grows.", photo:"images/basil1_20260615.jpg" },
  basil2:       { fact:"Ancient cultures saw basil as a symbol of love and protection; today it's the heart of pesto.", photo:"images/basil2_20260615.jpg" },
  parsley:      { fact:"Parsley is biennial — leaves the first year, flowers the second — and it's loaded with vitamin K.", photo:"images/parsley_20260615.jpg" },
  mint:         { fact:"Peppermint is a natural hybrid of watermint and spearmint, and it spreads so fast it's best kept potted.", photo:"images/mint_20260615.jpg" },
  ...
  rosemary:     { fact:"Rosemary means 'dew of the sea' and can live 20+ years — it loves dry feet and full sun.", photo:"images/rosemary_20260615.jpg" },
  strawberry:   { fact:"A strawberry isn't a true berry, and it's the only fruit with seeds on the outside — about 200 each.", photo:"images/strawberry_20260615.jpg" },
  strawberry_pot:{ fact:"A strawberry pot lets a whole patch of plants share one tall container — and runners from the top plants can root right into the lower pockets.", photo:"images/strawberry_pot_20260615.jpg" },
  tomato:       { fact:"Tomatoes are technically fruit; 'heirloom' means the variety has been saved and passed down 50+ years.", photo:"images/tomato_20260615.jpg" },
  cherry_tomato:{ fact:"Cherry tomatoes taste sweeter than big ones — more skin per bite concentrates the sugars.", photo:"images/cherry_tomato_20260615.jpg" },
  ...
  raspberry:    { fact:"Each raspberry is a cluster of tiny 'drupelets', and the canes fruit in their second year.", photo:"images/raspberry_20260615.jpg" },
  green_onion:  { fact:"Green onions are a cut-and-come-again crop — leave the white base and roots and the green tops regrow again and again.", photo:"images/onion_potato_pot_20260615.jpg" },
  potato:       { fact:"The potato you eat is a swollen underground stem (a tuber), not a root — and it grows from 'eyes' that sprout into new plants.", photo:"images/onion_potato_pot_20260615.jpg" },
  potato_sprout:{ fact:"A new potato sprout feeds first from the seed potato, then builds the leaves and roots that will support its tubers." },
  white_onion:  { fact:"An onion bulb is really a cluster of swollen leaf bases — and the tops flopping over is the plant's signal it's done bulbing.", photo:"images/onion_potato_pot_20260615.jpg" },
  dianthus:     { fact:"Dianthus means 'flower of the gods' in Greek, and many kinds smell just like cloves.", photo:"images/dianthus_20260615.jpg" },
  daisy:        { fact:"'Daisy' comes from 'day's eye' — the flower opens at dawn and closes again at dusk.", photo:"images/daisy_20260615.jpg" },
  candytuft:    { fact:"Candytuft is named for Candia (old Crete), not candy — though the clusters look sweet enough to eat.", photo:"images/candytuft_20260615.jpg" }
};
...
const WATER_INFO = {
  ...
  green_onion:{when:"Check the shared gray pot daily during the heat and water when its top inch starts drying, usually every couple of days. Only the green and recovering white onion remain in this pot.",thirst:"Shallow roots wilt quickly, but the recovering white onion must not sit wet, so use the soil check instead of watering automatically."},
  ...
  potato_sprout:{when:"Check the small temporary pot every morning and water when the top inch starts drying. Keep the newly emerged sprout evenly moist while it establishes, not constantly wet.",thirst:"A small pot can dry in a single hot day. Wilting or a very light pot means it waited too long."},
  ...
  turmeric:{when:"Check its separate temporary pot daily, but water only as the top inch dries until roots and shoots appear. Warm and lightly moist is safer than constantly wet.",thirst:"No sprout yet is normal. A firm healthy rhizome is better evidence than a rigid watering interval."},
...
const CARE_INFO = {
  ...
  jalapeno:{fact:"It is fruiting now: keep the canopy open, remove only yellow or badly damaged lower leaves, and support branches if the pepper load begins to bend them."},
...
const PEST_INFO = {
  ...
  basil1:{ look:"Aphids cluster on tender new tips and leaf undersides with sticky honeydew (sometimes black sooty mold). Whiteflies are common in the warm greenhouse — tiny white flies that lift off when disturbed, found on leaf undersides. Spider mites bring underside stippling and webbing in warm dry spots; slugs chew ragged holes and leave silvery slime trails at floor level.", fix:"Blast aphids off with water, then insecticidal soap or neem on the leaf undersides for aphids, whiteflies, and mites. Hang yellow sticky traps for whiteflies, hand-pick or trap slugs (beer or iron-phosphate bait), and let ladybugs and lacewings work as greenhouse predators." },
  basil2:{ look:"Same as the other basil: aphids on new tips and undersides (honeydew, sooty mold), whiteflies that fly up off the undersides when disturbed, spider mites (underside stippling and webbing) in warm dry corners, and slugs leaving ragged holes and slime trails near the floor.", fix:"Water-blast the aphids, then insecticidal soap or neem on the undersides for aphids, whiteflies, and mites. Yellow sticky traps for whiteflies, hand-pick or trap slugs, and encourage ladybugs and lacewings as predators." },
  ...
  ristra:{ look:"At the seedling stage the big risk is damping-off, a fungal disorder not a pest — the seedling collapses and pinches off right at the soil line and topples, from overwatering and poor airflow. Fungus gnats hover at the soil surface with root-chewing larvae in the wet mix; aphids cluster on the growing tips and undersides; two-spotted spider mites stipple and web the undersides in the warm dry greenhouse.", fix:"For damping-off, use a sterile mix, do not overwater, improve airflow, bottom-water, and let the surface dry between waterings. For fungus gnats, dry the top layer, set yellow sticky traps, and drench with BTI (mosquito bits). For aphids and mites, gently rinse or wipe them off at this small size, or spot-test a low-rate insecticidal soap since seedlings are tender." },
...
const FEED_INFO = {
  ...
  ristra:{ what:"A seedling with only a couple of true leaves needs very little — a dilute (quarter to half strength) balanced organic liquid such as fish emulsion plus kelp.", how:"Feed every 1 to 2 weeks once the first true leaves are established; overfeeding now causes weak leggy growth. Shift toward lower-N, higher P/K only much later once it flowers." },
...
const HARVEST_INFO = {
  ...
  jalapeno:{ongoing:true, badge:"🌶️ Harvest now", hdrNote:"green now · red later", signsLabel:"🌶️ What is ready", signs:"Several peppers are full-size, glossy, firm, and deep green in the July 14 photo, so they can be harvested now. Green jalapeños have the familiar crisp, bright heat. Leave selected peppers on the plant if you want them to ripen red; red fruit will be sweeter, fruitier, and usually hotter. Continue checking as the remaining flowers set new peppers.", how:"Harvest in the cool morning with clean scissors or pruners. Support the branch with one hand and snip each pepper with a short piece of stem attached; do not pull or twist hard, because loaded pepper branches split easily. Pick firm green peppers promptly to keep production moving, or leave a few to color fully red. Refrigerate fresh peppers unwashed in a loose bag and wash just before use.", fact:"Picking mature green peppers encourages the plant to keep flowering; leaving a few to turn red gives you a sweeter, hotter second style from the same plant."},
  green_onion:{ongoing:true, badge:"✂️ Snip as needed", hdrNote:"as needed", signsLabel:"🍴 When to pick", signs:"No schedule — snip the green tops whenever you cook. They are ready as soon as the tops are firm, upright, and at least pencil-thick; no need to wait for any bulbing, since scallions are best young and tender. Cut in the cool of the morning, which keeps the tops crisp and turgid — they wilt fast if cut in afternoon heat. Take the tallest outer tops and leave the rest to keep regrowing.", how:"In the morning, cut the green tops about an inch above the white base with scissors, leaving the roots and base in the pot — they regrow for a second and third cutting, and cutting (rather than pulling) avoids disturbing the neighboring potato and onion roots. Or pull a whole onion straight up by the soil line, roots and all, if you want the white part too. No curing needed — use fresh.", fact:"Keeping them: stand cut green onions in a glass with an inch of water on the counter or fridge, loosely bagged — they keep a week-plus and even keep growing. Longer: chop and freeze in a bag for cooking."},
  potato:{signs:"Not yet — the potatoes are sizing up underground (~70–90 days from planting). The signal to dig is when the foliage yellows, flops, and dies back (~90–120 days), which means the plant has finished bulking and the skins have thickened. For a few tender new potatoes you can sneak a hand in a couple weeks after any flowering. Harvest on a dry day — time of day matters less than the soil being dry, since wet-soil harvest damages and rots tubers.", how:"Stop watering 1–2 weeks before the main harvest so the skins set for storage. When the tops have died back, pick a dry day, tip the whole shallow pot out onto a tarp, and sift the tubers from the soil by hand — far easier than digging, and you will not spear them with a fork. For new potatoes, instead reach in along the side and pull a few by hand without uprooting the plant, then re-cover. Brush off the dirt — don't wash storage potatoes until you're ready to use them.", fact:"Keeping them: cure harvested potatoes a few days in a cool, dark, airy spot to toughen the skins, then store cool and dark — never the fridge, and away from onions. Cut off any green patches (light exposure)."},
...
const REMINDERS = [
  ...
  { id:"rem_tv_triage",       standing:true,     emoji:"📺", text:"10-min triage on the free 50-inch TV — grab the model number off the back sticker, check for a standby light, then flashlight test for a ghost image (ghost = ~$20 backlight fix). No buying parts until triage is done." },

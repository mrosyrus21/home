...
const PLANT_INFO = {
  turmeric:     { fact:"Turmeric is ginger's cousin — same rhizome family; its bright orange flesh is what colors curry, and it can take several weeks to break the surface after planting.", photo:"images/turmeric_example_cc0.jpg", photoPos:"center 42%", photoCredit:"Example photo · Maina Tudu · Wikimedia Commons · CC0" },
  ...
  potato_sprout:{ fact:"A new potato sprout feeds first from the seed potato, then builds the leaves and roots that will support its tubers.", photo:"images/potato_sprout_20260714.jpg", photoPos:"50% 45%" },

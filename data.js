...
const HARVEST_INFO = {
  ...
  strawberry_pot:{ongoing:true, signs:"Check every pocket — a berry is ready when it is fully, evenly red with no pale shoulders. Pockets ripen on their own schedule, so there is almost always one ready, and ripe ones hide behind the leaves.", how:"Pick each berry only when fully red, snipping the stem just above the green cap so you do not bruise it — never tug. Only a few are ripening at a time right now — check the pockets every few days and take only the fully red ones.", fact:"A strawberry pot gives a longer, staggered picking season than a single plant."},
  cherry_tomato:{ongoing:true, signs:"Coloring up now — the first cherries are turning red. Pick them as they go fully colored and slightly soft (a ripe one releases with a gentle twist), and once most of a cluster has colored, take the whole truss. Check every 2–3 days.", how:"Pick when fully colored and slightly soft. If most of a cluster is ripe, harvest the whole truss at once. Check daily once they start coloring.", fact:"Left too long they split, so pick promptly once they color up."},
  green_onion:{ongoing:true, badge:"✂️ Snip as needed", hdrNote:"as needed", signsLabel:"🍴 When to pick", signs:"No schedule — snip the green tops whenever you cook. Take the tallest outer tops and leave the rest to keep regrowing.", how:"Cut the green tops about an inch above the soil with scissors, leaving the white base and roots in the pot — they regrow several times. Or pull a whole onion, base and all, if you want the white part too.", fact:"Keeping them: stand cut green onions in a glass with an inch of water on the counter or fridge, loosely bagged — they keep a week-plus and even keep growing. Longer: chop and freeze in a bag for cooking."},
  potato:{signs:"Not yet — the potatoes are sizing up underground (~70–90 days from planting). The signal to dig is when the foliage yellows, flops, and dies back. For a few tender 'new potatoes' you can sneak a hand in a couple weeks after any flowering.", how:"When the tops have died back, stop watering for about a week, then tip the pot out and sort the tubers from the soil by hand. Brush off the dirt — don't wash them until you're ready to use them.", fact:"Keeping them: cure harvested potatoes a few days in a cool, dark, airy spot to toughen the skins, then store cool and dark — never the fridge, and away from onions. Cut off any green patches (light exposure)."},
  white_onion:{signs:"Not yet — the bulb is sizing up (~90–120 days). It's ready when the green tops naturally flop over and start to brown on their own. Don't bend them down yourself.", how:"Once the tops have flopped and browned, stop watering, wait ~1–2 weeks, then lift the bulb on a dry day. Leave the skins and roots on for curing.", fact:"Keeping it: cure the onion in a single layer somewhere dry, airy, and shaded for 1–2 weeks until the neck is papery, then trim the roots and store cool and dry. Well-cured onions keep for months."},
  tomato:{ongoing:true, signs:"It's started! The first big fruit is turning yellow/pink (the breaker stage). Pick it once it shows full color and gives slightly to a squeeze — or pick at first blush and finish it on the counter to beat cracking and critters. The rest are still green and coming.", how:"Twist gently or snip the stem once deep-colored with a slight give — or pick at first blush and ripen on the counter to beat cracking and critters. Never refrigerate.", fact:"Counter-ripening from the breaker stage protects the fruit from splitting."},
};

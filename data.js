...
const PLANTS = [
  ...
  { id:"potato", light:"☀️ Full sun", waterChip:"💧 every 2 days — evenly moist", harvestChip:"🥔 ~70–90 days — dig when the tops die back", name:"Golden Potatoes", emoji:"🥔", loc:"outdoor", freq:"Two golden potatoes growing underground in the shared wide gray pot (you won't see them — watch the foliage). Keep the soil evenly moist while they bulk up; as the stems grow, mound a little soil over them so the tubers stay covered.", days:2, trimDays:30, note:"Jul 1 — one potato is up with beautiful leaves; the other (checked by digging) has rooted but isn't as far along yet. Both alive — re-covered; keep mounding soil as the stems grow.",
  ...
  { id:"turmeric", light:"🌥️ Part shade — bright, no harsh afternoon sun", waterChip:"💧 every 2 days — evenly moist", harvestChip:"🫚 ~8–10 months — lift when leaves yellow & die back", name:"Turmeric", emoji:"🫚", loc:"outdoor", freq:"Two turmeric rhizomes (soaked before planting) sharing the wide gray pot with the ginger and onions. Loves warmth and steady, even moisture — water at the base every couple of days; like ginger it rots in soggy soil. Slow to emerge — give it a few weeks.", days:2, trimDays:30, note:"Jul 1 — planted 2 soaked turmeric roots. Slow to sprout; leaves push up in a few weeks. Keep warm and evenly moist.",

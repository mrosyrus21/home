...
const TASKS = {
  ...
  gnat_nuke:      { room:"garden", label:"🪴 REPOT DAY — all 5 indoor plants, SAME day (the gnat reset). Supply run first: indoor potting mix · cactus mix · perlite · orchid bark · coco coir. Then bare-root each plant, scrub pots, fresh custom mix, gravel cap. Method + per-plant mixes: Plants → Care", level:"easy" },
...
const PLANTS = [
  // ── INDOOR ────────────────────────────────────────────────────────────────
  { id:"philodendron", light:"☀️ Bright indirect", waterChip:"💧 every 7 days — top 1–2 in dry", harvestChip:"🌿 foliage — not harvested", name:"Heartleaf Philodendron", emoji:"🪴", loc:"indoor", freq:"Water when the top 1–2 inches of soil are dry; bright indirect light. 🦟 Gnat reset = REPOT DAY Sun Jun 14 (full plan: Plants → Care). After the repot: first 2–3 waterings = BTI tea for insurance, then back to normal water.", days:7, overwater:true },
  { id:"ivy", light:"🌥️ Bright indirect", waterChip:"💧 every 7 days", harvestChip:"🌿 foliage — not harvested",          name:"Royal Tea Ivy",           emoji:"🍃", loc:"indoor", freq:"Keep lightly moist — water when the top inch dries. Likes humidity. 🦟 Gnat reset = REPOT DAY Sun Jun 14 (full plan: Plants → Care). After the repot: first 2–3 waterings = BTI tea for insurance, then back to normal water.", days:7, overwater:true },
  ...
  { id:"jalapeno", light:"☀️ Full sun 6–8h", waterChip:"💧 every 2–3 days", harvestChip:"🌶️ just flowering — peppers later; pick firm & full-size (green)",      name:"Jalapeño",            emoji:"🌶️", loc:"outdoor", freq:"Morning at the base — every 2-3 days, let the top 2 inches dry. Less water = hotter pepper.", days:2, trimDays:21,
  ...
  { id:"green_onion", light:"☀️ Full sun", waterChip:"💧 every 2 days — evenly moist", harvestChip:"✂️ snip green tops as you cook — they regrow", name:"Green Onions", emoji:"🧅", loc:"outdoor", freq:"Two green onions on the side of the shared wide gray pot. Keep evenly moist — water at the base every couple of days; they're shallow-rooted and don't like drying out.", days:2, trimDays:14,
  ...
  { id:"potato", light:"☀️ Full sun", waterChip:"💧 every 2 days — evenly moist", harvestChip:"🥔 ~70–90 days — dig when the tops die back", name:"Golden Potatoes", emoji:"🥔", loc:"outdoor", freq:"Two golden potatoes growing underground in the shared wide gray pot (you won't see them — watch the foliage). Keep the soil evenly moist while they bulk up; as the stems grow, mound a little soil over them so the tubers stay covered.", days:2, trimDays:30,
...
const PLANT_INFO = {
  ...
  ivy:          { fact:"Ivy clings to almost any surface using tiny root-like 'holdfasts' that secrete a natural glue.", photo:"images/ivy_20260615.jpg" },
  ...
  jalapeno:     { fact:"A jalapeño's heat lives in the white pith, not the seeds — and less water makes it hotter.", photo:"images/jalapeno_20260615.jpg" },
...
const WATER_INFO = {
  philodendron:{when:"Check weekly. Water only when the top 1–2 inches of soil feel dry, then water deeply until it drains from the bottom and empty the saucer. Keep it in bright indirect light. 🦟 Gnat reset = REPOT DAY Sun Jun 14 (full plan: Plants → Care). After the repot: first 2–3 waterings = BTI tea for insurance, then back to normal water.",thirst:"Forgiving and drought-tolerant — it would much rather sit a little dry than soggy, which rots its roots."},
  ivy:{when:"Water about weekly, when the top inch is dry — soak until it drains, then tip out the saucer. Mist the leaves or group it with other plants for humidity. 🦟 Gnat reset = REPOT DAY Sun Jun 14 (full plan: Plants → Care). After the repot: first 2–3 waterings = BTI tea for insurance, then back to normal water.",thirst:"A thirsty plant that still hates wet feet: it wants the soil moist but never standing in water."},
  ...
  green_onion:{when:"Water at the base every couple of days, keeping the mix evenly moist — they share the wide gray pot, so one good drink covers the whole pot.",thirst:"Shallow-rooted and quick to feel drought — steady moisture keeps the tops tender instead of tough."},
  potato:{when:"Keep the soil evenly moist every couple of days while the plants grow and the tubers bulk up. Ease right off once the tops start to yellow and die back.",thirst:"Even moisture during bulking makes smooth, well-sized potatoes; big wet-dry swings cause knobs and hollow centers."},
  white_onion:{when:"Steady, even moisture every couple of days while the bulb is sizing up, then stop watering once the tops flop over so it can cure.",thirst:"Onions size up best with consistent water — let them dry hard mid-season and the bulb stays small."},
...
const PEST_INFO = {
  philodendron:{ look:"Spider mites are the main worry in Denver's dry indoor air — check leaf undersides and the spot where leaf meets stem for fine yellow stippling and faint webbing in the leaf axils. Mealybugs show as white cottony tufts in the leaf axils, nodes, and new tips; aphids cluster on tender new growth and leave sticky honeydew.", fix:"Wipe and water-blast the leaves to knock off mites and raise humidity; spot-treat mealybugs with a cotton swab dipped in 70% rubbing alcohol. For wider outbreaks use insecticidal soap or neem oil, top and bottom of leaves, repeated weekly until clear." },
  ivy:{ look:"Ivy is the most mite-prone plant in the lineup — check leaf undersides for stippling, a dull bronzed cast, and fine webbing. Also look for aphids on new tips (clusters plus honeydew), brown scale bumps on stems and undersides, and white cottony mealybugs tucked in the leaf axils.", fix:"Shower the foliage in the sink monthly, rinsing leaf undersides, to suppress mites. Spray insecticidal soap or neem oil top and bottom weekly; dab scale and mealybugs with a rubbing-alcohol swab; isolate any infested plant since ivy mites spread fast." },
...
const FEED_INFO = {
  philodendron:{ what:"A nitrogen-leaning feed suits this leafy vine — diluted fish emulsion, worm-casting tea, or a balanced organic liquid at half strength.", how:"Feed monthly through spring and summer at half strength; skip feeding entirely in winter." },
  ivy:{ what:"A balanced or slightly nitrogen-forward organic liquid — fish emulsion or seaweed/kelp — at half strength.", how:"Feed monthly in spring and summer; do not overfeed, since lush over-fed growth attracts more pests, and give no winter feeding." },
